...
namespace QuanLySieuThi.quanly
{
    ...
    public partial class qlphieuxuat : Form
    {
        ...
        public void tenbang()
        {
            ...
            dta2.Columns[2].HeaderText = "Gía bán"; dta1.Columns[2].Width = 110;
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (c > a)
                {
                    MessageBox.Show("Số lượng Sản phảm này trong kho không đủ ", "Thông báo ! ");
        ...
        private void btn_luu_Click(object sender, EventArgs e)
        {
            ...
            dta2.Columns[1].HeaderText = "Tên Thuốc"; dta2.Columns[1].Width = 120;
            dta2.Columns[2].HeaderText = "Gía Nhập"; dta2.Columns[2].Width = 120;
            dta2.Columns[3].HeaderText = "Số lượng"; dta2.Columns[3].Width = 120;
            dta2.Columns[4].HeaderText = "Dang thuốc"; dta2.Columns[4].Width = 120;
            tenbang();
        ...
        {
            if (MessageBox.Show("Bạn có chắc chán thoát không ?", "Thông báo", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                this.Close();
            }
        }
