...
namespace QuanLySieuThi
{
    class XuatExecl
    {
        ...
        {
            duongdan = @"C:\Users\TUF-GAMING\Desktop\PhanmemquanlySieuThi\excel\taikhoan";
            app obj = new app();
        ...
        {
            duongdan = @"C:\Users\TUF-GAMING\Desktop\PhanmemquanlySieuThi\excel\ThongTinPhieu";
            app obj = new app();
            obj.Application.Workbooks.Add(Type.Missing);
            obj.Columns.ColumnWidth = 25;
            obj.Cells["A2", "C2"] = "";
        ...
        {
            duongdan = @"C:\Users\TUF-GAMING\Desktop\PhanmemquanlySieuThi\excel\NhapNhieu";
            app obj = new app();
            obj.Application.Workbooks.Add(Type.Missing);
            obj.Columns.ColumnWidth = 25;
